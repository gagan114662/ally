...
class Calendar1(QCAlgorithm):
    ...
    def CoarseSelection(self, coarse):
        filtered = [c for c in coarse if c.HasFundamentalData and c.Price > 3.0]
        byDollarVol = sorted(filtered, key=lambda c: c.DollarVolume, reverse=True)[:1000]
