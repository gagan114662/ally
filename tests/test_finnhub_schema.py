#!/usr/bin/env python3
"""
Finnhub schema validation tests - verify data structure and formats
"""
...
def test_finnhub_schema_offline(interval):
    """
    Offline schema validation for Finnhub adapter. No network calls.
    """
    res = data_load_ohlcv(
        symbols=["AAPL"],
        interval=interval,
...
def test_finnhub_interval_mapping_equivalence():
    """
    1h and 60min should map to the same Finnhub params under the hood.
...
def test_finnhub_unsupported_interval_raises():
    """
...
def test_finnhub_multi_symbol_offline():
    """
...
def test_finnhub_timezone_utc_enforcement():
    """
...
def test_finnhub_ohlc_relationships():
    """
